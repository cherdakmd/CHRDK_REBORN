...
public class GearManager {
    ...
    private String getEnchantDescription(String enchant, int level) {
        switch (enchant) {
            case "fire_aspect": return "Огненный аспект " + level + " (поджигает врагов)";
            case "frost": return "Морозный удар " + level + " (замедляет цель)";
            case "lightning": return "Удар молнии " + level + " (шанс доп. урона)";
            case "soul_reaper": return "Жнец душ " + level + " (лечит при убийстве)";
            case "void_strike": return "Удар бездны " + level + " (игнорирует броню)";
            case "vampirism": return "Вампиризм " + (level * 10) + "% (крадёт HP при ударе)";
            case "venom": return "Отравление " + level + " (яд на 3 сек)";
            case "disintegration": return "Распад " + level + " (шанс мгновенной смерти)";
            case "wind_walker": return "Шагающий по ветру " + level + " (скорость + прыжок)";
            case "critical_strike": return "Критический удар " + level + " (x2 урон, шанс +" + (level * 5) + "%)";
            case "flame_tongue": return "Пылающий язык " + level + " (огненный урон)";
            case "mana_shield": return "Мана-щит (поглощает " + (level * 15) + "% урона)";
            case "shadow_step": return "Теневой шаг (ускорение после уклонения)";
            case "iron_will": return "Железная воля " + level + " (устойчивость к оглушению)";
            case "berserker": return "Берсерк " + level + " (урон↑ при низком HP)";
            ...
            case "lifesteal_aura": return "Аура вампиризма " + level + " (вампиризм союзникам в 5 блоках)";
            case "double_jump": return "Двойной прыжок (прыжок в воздухе)";
            case "aqua_affinity": return "Подводная скорость (быстрее под водой)";
            case "feather_falling": return "Плавное падение (−50% урона)";
            case "efficiency": return "Эффективность " + level + " (быстрее копать)";
            case "fortune": return "Удача " + level + " (больше ресурсов)";
            case "luck_of_the_sea": return "Морская удача " + level + " (шанс сокровищ)";
            case "thorns": return "Шипы " + level + " (отражение урона)";
            case "unbreaking": return "Прочность " + level + " (дольше не ломается)";
            case "loyalty": return "Верность " + level + " (трезубец возвращается)";
            case "channeling": return "Канал " + level + " (молния в грозу)";
            case "quick_charge": return "Быстрая зарядка " + level + " (арбалет)";
            case "piercing": return "Пробивание " + level + " (стрела сквозь врагов)";
            case "lure": return "Приманка " + level + " (рыба клюёт быстрее)";
