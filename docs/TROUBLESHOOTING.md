...
1. Замените `VKChat-2.0.0-all.jar` и `vkchat_offline-2.0.0.jar` на актуальные.
...
Походы запускаются только если Minecraft-персонаж оффлайн. Меню может открываться онлайн, но маршрут стартует только после выхода с сервера.
