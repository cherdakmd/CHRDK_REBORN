    ...
    public static void handle(VKChatPlugin plugin, String text, int fromId, int peer) {
        ...
        if (cmd.equals("!помощь") || cmd.equals("!help") || cmd.equals("!клавиатура")) {
            String help = " Доступные команды:\n\n" +
                    ...
                    " !работы - Твои уровни профессий\n" +
                    " !рейтинг - Узнать свою репутацию\n\n" +
                    " Топы:\n" +
                    " !топ - Топ лучших игроков сервера\n" +
                    " !топреп - Топ богачей чата\n\n" +
                    " Игры и Экономика:\n" +
                    " !поход - Оффлайн-экспедиция за лутом\n" +
                    " !бонус - Ежедневная халява\n" +
                    " !сейф / !код <число> - Взлом сейфа\n" +
                    " !казино <ставка> - Ставка на очки\n" +
                    " !рулетка - Русская рулетка (Риск!)\n" +
                    " !заказ <ник> <сумма> - Заказать игрока\n" +
