...
public class StreamChecker {
    ...
    private void announce(StreamEvent e) {
        ...
        Bukkit.broadcastMessage(ChatColor.GOLD + "🎯 /stream reward — получи награду за подписку на канал!");
    ...
    public boolean claimReward(Player p) {
        ...
        p.sendMessage(ChatColor.GREEN + "✓ Спасибо за подписку на канал! +" + rep + " репутации.");
        return true;
    }
